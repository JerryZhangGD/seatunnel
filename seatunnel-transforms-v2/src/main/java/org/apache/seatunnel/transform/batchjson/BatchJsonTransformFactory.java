...
public class BatchJsonTransformFactory implements TableTransformFactory {
    ...
    public OptionRule optionRule() {
        return OptionRule.builder()
                .required(
                        BatchJsonTransformConfig.BATCH_SIZE, BatchJsonTransformConfig.JSON_TEMPLATE)
                .optional(
                        BatchJsonTransformConfig.BATCH_FIELDS,
